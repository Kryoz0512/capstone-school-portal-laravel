...
import { Calendar, Clock, BookOpen, User, Users, AlertCircle, GraduationCap } from 'lucide-react'
...
export default function AddRoomScheduleModal({
    open, onOpenChange, roomId, gradeLevels, classSections, subjects, teachers, teacherSubjects, onSuccess,
}: Props) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await axios.post('/admin/enrollment/schedules', {
            ...
            <DialogContent className="max-w-6xl w-full max-h-[90vh] overflow-y-auto p-0 gap-0">
                <DialogHeader className="px-6 pt-6 pb-4 border-b border-gray-100">
                    <div className="flex items-start gap-3">
                        <div className="p-2.5 bg-green-600 rounded-lg shrink-0">
                            <Calendar className="w-5 h-5 text-white" />
                        </div>
                        <div>
                            <DialogTitle className="text-lg">Add Schedule to This Room</DialogTitle>
                            <DialogDescription className="mt-0.5">Assign a class to this room</DialogDescription>
                        </div>
                    </div>
                </DialogHeader>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="relative">
                                    ...
                                    {subjectId && filteredTeachers.length === 0 && (
                                        <p className="text-xs text-yellow-600 mt-1">No teachers assigned to this subject</p>
                                    )}
