...
import { Pencil, User, IdCard, BookOpen, Lock, CalendarDays, MapPin, Phone, Check, X } from 'lucide-react'
...
export default function EditTeacherModal({ open, onOpenChange, teacher, gradeLevels = [], subjects = [] }: EditTeacherModalProps) {
    ...
    useEffect(() => {
        if (teacher) {
            ...
            // Parse existing comma-separated subjects
            const existingSubjects = teacher.subject
            ...
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto p-0 gap-0">
                ...
                <DialogHeader className="px-6 pt-6 pb-5 bg-gradient-to-br from-green-700 to-green-600 rounded-t-lg space-y-0">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <DialogTitle className="text-white text-lg font-semibold">Edit Teacher</DialogTitle>
                            <p className="text-sm text-green-50/90 mt-0.5">Update information and assignment details</p>
                        </div>
                    </div>
                </DialogHeader>
                ...
                <form onSubmit={handleSubmit} className="px-6 py-6 space-y-7">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            />
                            <p className="text-xs text-gray-400 mt-1">Auto-generated from first and last name</p>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <Input
                                ...
                                minLength={8}
                            />
                            <p className="text-xs text-gray-400 mt-1">Leave blank to keep current password. Minimum 8 characters if changing.</p>
