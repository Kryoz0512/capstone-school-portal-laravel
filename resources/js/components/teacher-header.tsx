...
export default function TeacherHeader({ user, teacher }: HeaderProps) {
    ...
    // Then try from props (controller) - might be an object
        ...
        } else if (typeof teacher.profile_picture === 'object' && teacher.profile_picture !== null && 'file_path' in teacher.profile_picture) {
            // It's the full profile picture object, extract the URL
            const picObj = teacher.profile_picture as { file_path: string }
