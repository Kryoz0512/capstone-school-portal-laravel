...
export default function AdviserClassList({ section, schoolYears, students, filters, noAssignment, auth }: Props) {
        ...
        <AdviserLayout user={auth?.user}>
            ...
            <div className="space-y-6">
                <div className="no-print">
                    ...
                    <p className="text-sm text-gray-500 mt-1">All students in your advisory class</p>
                </div>
