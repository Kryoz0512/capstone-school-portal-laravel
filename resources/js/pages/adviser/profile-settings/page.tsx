...
export default function ProfileSettings({ teacher, subjects = [], auth }: Props) {
    ...
    const handleProfileSubmit = (e: React.FormEvent) => {
        e.preventDefault()
        profileForm.put('/adviser/profile-settings', { preserveScroll: true })
    }

    const handlePasswordSubmit = (e: React.FormEvent) => {
        e.preventDefault()
        passwordForm.put('/adviser/profile-settings/password', {
            preserveScroll: true,
    ...
    const handleFileSelect = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        router.post('/adviser/profile-settings/picture', formData, {
            preserveScroll: true,
    ...
    const handleDeletePicture = () => {
        if (confirm('Are you sure you want to delete your profile picture?')) {
            router.delete('/adviser/profile-settings/picture', {
                preserveScroll: true,
