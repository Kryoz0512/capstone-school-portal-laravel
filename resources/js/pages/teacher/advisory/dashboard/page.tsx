...
export default function TeacherAdvisoryDashboard({ stats, advisorySection, noAssignment, readOnly, auth }: Props) {
    ...
    return (
        <TeacherLayout user={auth?.user}>
            <Head title="Advisory Overview" />
            <div className="space-y-6">
                <div>
                    <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Advisory Overview</h2>
                    <p className="text-gray-500 mt-1 text-sm sm:text-base">View-only summary of your advisory class</p>
                </div>

                {readOnly && (
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <p className="text-sm text-blue-800">
                            This section is read-only in the Teacher Portal. Use the Adviser Portal to manage advisory class tasks.
                        </p>
                    </div>
                )}
